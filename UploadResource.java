...
public class UploadResource{
    ...
    public String uploadForm() {
        ...
        String html = "<html><head>$style<meta charset=\"UTF-8\"><title>Enviar Arquivo</title></head>";
                html += "<body><div class=\"header\">Biblioteca Virtual";
                html +="<a href=\"listar\">Cancelar</a></div>";
                html +="<form action=\"upload\" method=\"post\" enctype=\"multipart/form-data\">";
                html +="<h1>Selecione um arquivo para gerar um novo item para sua biblioteca:</h1>";
                html +="<label for=\"file\">Clique aqui para escolher um arquivo<p>";
                html +="<input type=\"file\" accept=\"application/pdf\" id=\"file\" name=\"file\" required><br>";
                html +="<input type=\"submit\" id=\"enviar\"/>";
                html +="</form>";
                html +="</body>";
                html +="</html>";
